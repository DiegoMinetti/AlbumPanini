 ...
 *
 * Las funciones de detección (`isStandaloneDisplay`, `isIosSafari` y el
 * tipo `BeforeInstallPromptEvent`) viven en `./pwaDetection` para que
 * este archivo solo exporte el componente y el fast refresh funcione.
 */
